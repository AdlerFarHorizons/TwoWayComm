// V2_mod revisions Jul 21, 2013
// Lou Nigra

// 1) 'Speed' from 7812 to 156250 for next TX for FCC unrestricted
//     application (10 sec between transmissions)
// 2) Chan 0 frequency from 433.99 to 440 MHz for better to reduce
//    APRS 144.39 MHz 3rd harmonic blocking at 433.17 Mhz
// 3) TX from 5 dBm to 10 dBm.
...
// PA Table - assumes default FREND0[2:0]=0 (no ramping)
