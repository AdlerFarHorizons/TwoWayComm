  ...
  while(1)//infinite program loop
  {
     ...
     */
     ...
     {  
       ...
       //TXS[tsp][2]=
       collect2(5,3,&TXS[tsp][2]);//getting 1 byte frome preipherral 5 to be transmitted through I2C interface
...
ISR(TIMER1_COMPA_vect)//first timer interrup
{
 ...
 /****periodic transmissions ***/ 
  if(isc%20==0&&allow==1)//the if statments checks for every 10 seconds sinc in this set up isc updates twice in a second 
  {
